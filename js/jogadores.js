if (sessionStorage.getItem('logado')){
    ...
    const carregarDados = async (url) => {
        ...
        <div style = 'display: flex; flex-direction: column; justify-content: center; align-items: center; width: fit-content; margin: 0 auto; margin-right: -100px; font-family: "Roboto", sans-serif'>
            <img src = 'imagensap2/imagens/carregandoatletasimage.jpg'/>
            <h3>Carregando atletas...</h3>
        </div>
        `;
    ...
    escudo.src = 'imagensap2/imagens/escudo.png';

    const title = document.createElement('h1');
    title.innerHTML = 'Elenco do clube mais tradicional';
    ...
    btn_feminino.innerHTML = 'jogadoras/feminino';
    ...
    btn_masculino.innerHTML = 'jogadores/masculino';
    ...
    btn_all.innerHTML = 'Todos os atletas';
    btn_all.onclick = () => {
        container.innerHTML = '';
    ...
    inputPesquisa.placeholder = 'pesquisar/posição';
    ...
    <select>
        ...
        <option value='Feminino'>Jogadoras time feminino</option>
        <option value='Masculino'>Jogadores time masculino</option>
        <option value='All'>Todos jogadores e jogadoras</option>
    </select>
    `;
    select.onchange = (e) => {
